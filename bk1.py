...
THRESHOLD_HELMET = 0.25  # hoặc giá trị khác như 0.8 nếu cần nghiêm ngặt hơn
...
def crop_pose(image_path, save_folder):
    ...
    face_margin_x = 20
    top_margin = 30
    bottom_margin = 80  # 👉 mở rộng thêm phía dưới để chắc chắn có miệng
...
def detect_smile(face_image_path, threshold=0.3):
