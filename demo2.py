...
TEST_IMAGE_PATH = "test/thieubaotay.jpg"
OUTPUT_FOLDER = "check"
...
results = {}
early_fail = False  # nếu quần hoặc áo sai, bỏ qua các phần còn lại
...
for label in labels:
    if label == "nametag":
        ...
        # Nếu phát hiện shirt hoặc pants sai => đánh dấu fail toàn bộ sau
